 ...
 * up to version 1551953901.
 * Generated on 2019-03-07 10:18:21 by vagrant
 */
class PropelMigration_1551953901
{
    public $comment = '';
...
CREATE INDEX "index-spy_company-fk_company_type" ON "spy_company" ("fk_company_type");
...
CREATE INDEX "index-spy_company_store-fk_company" ON "spy_company_store" ("fk_company");
...
CREATE INDEX "index-spy_company_role_to_company_user-fk_company_role" ON "spy_company_role_to_company_user" ("fk_company_role");
...
CREATE INDEX "index-spy_company_supplier_to_product-fk_company" ON "spy_company_supplier_to_product" ("fk_company");

CREATE INDEX "index-spy_company_supplier_to_product-fk_product" ON "spy_company_supplier_to_product" ("fk_product");
...
CREATE INDEX "index-spy_dataset_row_column_value-fk_dataset" ON "spy_dataset_row_column_value" ("fk_dataset");

CREATE INDEX "index-spy_dataset_row_column_value-fk_dataset_row" ON "spy_dataset_row_column_value" ("fk_dataset_row");

CREATE INDEX "index-spy_dataset_row_column_value-fk_dataset_column" ON "spy_dataset_row_column_value" ("fk_dataset_column");
...
CREATE INDEX "index-spy_dataset_localized_attributes-fk_dataset" ON "spy_dataset_localized_attributes" ("fk_dataset");

CREATE INDEX "index-spy_dataset_localized_attributes-fk_locale" ON "spy_dataset_localized_attributes" ("fk_locale");
...
CREATE INDEX "index-spy_offer-fk_user" ON "spy_offer" ("fk_user");
...
CREATE INDEX "index-spy_price_product-fk_company" ON "spy_price_product" ("fk_company");
...
CREATE INDEX "index-spy_product_packaging_unit-fk_product" ON "spy_product_packaging_unit" ("fk_product");
...
(
    ...
    CONSTRAINT "spy_product_packaging_unit_amount-unique-fk_product_pu" UNIQUE ("fk_product_packaging_unit")
);

CREATE INDEX "index-spy_product_packaging_unit_amount-fk_product-e78d6a5960c0" ON "spy_product_packaging_unit_amount" ("fk_product_packaging_unit");
...
CREATE INDEX "index-spy_product_packaging_lead_product-fk_product_abstract" ON "spy_product_packaging_lead_product" ("fk_product_abstract");

CREATE INDEX "index-spy_product_packaging_lead_product-fk_product" ON "spy_product_packaging_lead_product" ("fk_product");
...
CREATE INDEX "index-spy_sales_order-fk_order_source" ON "spy_sales_order" ("fk_order_source");
...
CREATE INDEX "index-spy_shopping_list_item_note-fk_shopping_list_item" ON "spy_shopping_list_item_note" ("fk_shopping_list_item");
...
CREATE INDEX "index-spy_shopping_list_product_option-fk_shopping_list_item" ON "spy_shopping_list_product_option" ("fk_shopping_list_item");
